...
clock60 = dict(zip(range(60), range(0,360,6))) #for seconds
...
while True:
    ...
    #digital clock
    time_render = font.render(f'{t:%H:%M:%S}', True, pygame.Color('forestgreen'), pygame.Color('blue'))
